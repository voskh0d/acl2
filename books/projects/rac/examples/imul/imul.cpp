...
tuple<bool, ui64, ui64> ImulTest(ui32 s1, ui32 s2) {
  ...
  return tuple<bool, ui64, ui64>(spec_result == imul_result, spec_result,
                                 imul_result);
}
...
int main(int argc, char *argv[]) {
  ...
  while (!cin.eof()) {
    ...
    // On each iteration of this loop, two 32-bit integers are read in and
    // passed to Imul.
