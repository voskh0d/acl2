...
bool
Program::registerType(DefinedType *t) {
...
DefinedType *
Program::getType(const std::string& name) {
...
bool
Program::registerConstDec(ConstDec *d) {
...
ConstDec *
Program::getConstDec(const std::string& name) {
...
bool
Program::registerTemplate(Template *t) {
...
Template *
Program::getTemplate(const std::string& name) {
...
bool
Program::registerFunDef(FunDef *f) {
...
FunDef *
Program::getFunDef(const std::string& name) {
...
void
Program::displayTypeDefs (std::ostream &os, DispMode mode) const
{
...
void
Program::displayConstDecs (std::ostream &os, DispMode mode) const
{
  if (mode == DispMode::rac)
...
void
Program::displayFunDefs (std::ostream &os, DispMode mode) const
{
  if (mode == DispMode::rac)
