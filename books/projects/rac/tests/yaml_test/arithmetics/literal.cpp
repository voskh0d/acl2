...
int main() {
  ...
  static_assert(std::is_same_v<decltype(1ul), unsigned long>);

  static_assert(std::is_same_v<decltype(0x1), int>);
  static_assert(std::is_same_v<decltype(0x1u), unsigned>);
  static_assert(std::is_same_v<decltype(0x1l), long>);
  static_assert(std::is_same_v<decltype(0x1ul), unsigned long>);

  static_assert(std::is_same_v<decltype(0xFFFFFFFF), unsigned>);
  static_assert(std::is_same_v<decltype(4294967295), long>);
}
